...
var APPS = {
    'cine': {title: 'Netflix', path: 'script/Apps/Cine/index.html', icon: 'https://cdn.worldvectorlogo.com/logos/netflix-logo-icon.svg', pinned: true},
    ...
    'files': {title: 'Game Store', path: 'script/Apps/Ps5/index.html', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Microsoft_Store_logo_dark.svg/500px-Microsoft_Store_logo_dark.svg.png', pinned: true},
    'web': {title: 'Web', path: 'script/Apps/Web/index.html', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeD89ZcX5W1FBtal7RerasT27q-OmZqnBixQ&s', pinned: true},
    ...
    'ciniai': {title: 'AI', path: 'script/Apps/Cini/index.html', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkLXhvns5Rrdf-XBNlWcPIRh0hlJfWnEtBWg&s', pinned: false},
    'VM': {title: 'Windows VM', path: 'script/Apps/VM/index.html', icon: 'https://static1.squarespace.com/static/68e69c83884dc82cc035a923/69454e29c6db7516b2566fca/69454e32c6db7516b256749a/1766149682532/Virtualbox_logo.png?format=original', pinned: false},
    ...
    'Geforce': {title: 'Steam', path: 'script/Apps/Geforce/index.html', icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Steam_icon_logo.svg/960px-Steam_icon_logo.svg.png?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail&_=20220611141426', pinned: false},
